                        ...
                        <div class="form-inner">
                            ...
                            <form method="POST" action="{{ route('contact.submit') }}">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <p>By providing a telephone number and submitting the form, you are consenting to be
                                        contacted by SMS text message and agreeing to our <a
                                            href="{{ route('privacy-policy') }}">Privacy Policy</a>. Message frequency may
                                        vary. Message and data rates may apply. Reply STOP to opt out of further messaging.
                                        Reply HELP for more information.</p>
                                </div>
                            </form>
