                        ...
                        <div class="service-sidebar mr_40">
                            <div class="category-widget mb_40">
                                <ul class="category-list clearfix">
                                    ...
                                    <li><a href="home-services" class="current">Home Services<i class="icon-42"></i></a></li>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="service-details-content">
                            <div class="sec-title mb_70">
                                <span class="sub-title mb_10">Home Services </span>
                            ...
                            <div class="text-box mb_110">
                                ...
                                <p>3. Lack of degital marketing for local branding </p>
                                
                            </div>
                            <div class="text-box mb_70">
                                <h2>How we help?</h2>
                                <p><b> Relevant Talent & Job Roles</b></p>
                                <p><b>Customer Support Agents</b>- Handle service inquiries and bookings</p>
                                <p><b>Field Service Coordinators</b>- Manage technician dispatching</p>
                                <p><b>Operations Managers</b>- Oversee service efficiency</p>
                                <p><b>Social Media Managers</b>- Promote local business branding</p>

                            </div>
                            <div class="tabs-box mb_50">
                                <ul class="tab-btns tab-buttons">
                                    <li class="tab-btn active-btn" data-tab="#tab-1"><i class="icon-43"></i>Limited online presence</li>
                                    <li class="tab-btn" data-tab="#tab-2"><i class="icon-43"></i>Inefficient sales processes</li>
                                    <li class="tab-btn" data-tab="#tab-3"><i class="icon-43"></i>Overwhelmed support teams</li>
                                </ul>
                                <div class="tabs-content">
                                    <div class="tab active-tab" id="tab-1">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="assets/images/home1.png" alt=""></figure>
                                            <div class="content-box">
                                                <h6>Limited online presence</h6>
                                                <p>Managing high volumes of customer inquiries</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab" id="tab-2">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="assets/images/home2.png" alt=""></figure>
                                            <div class="content-box">
                                                <h6>Inefficient sales processes</h6>
                                                <p>Preventing missed appointments and optimizing operations</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab" id="tab-3">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="assets/images/home3.png" alt=""></figure>
                                            <div class="content-box">
                                                <h6>Overwhelmed support teams</h6>
                                                <p>Overcoming lack of digital marketing for local branding</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
