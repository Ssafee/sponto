                        ...
                        <div class="service-sidebar mr_40">
                            <div class="category-widget mb_40">
                                <ul class="category-list clearfix">
                                    ...
                                    <li><a href="home-services">Home Services<i class="icon-42"></i></a></li>
                            ...
                            <!-- <div class="download-widget">
                                ...
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/resource/book-3.png" alt=""></figure>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="service-details-content">
                            <div class="sec-title mb_70">
                                <span class="sub-title mb_10">Accounting & Finance</span>
                                <h2>Overview & Challenges</h2>
                            ...
                            <div class="text-box mb_50">
                                ...
                                <p>3. Maintaining accuracy in bookkeeping and payroll</p>
                                
                            </div>
                            <div class="text-box mb_70">
                                <h2>How we help?</h2>
                                <p><b> Relevant Talent & Job Roles</b></p>
                                <p><b>Accountants</b>- Ensure accurate financial reporting and compliance</p>
                                <p><b>Financial Analysts</b>- Provide data-driven insights for strategic decision-making</p>
                                <p><b>Bookkeepers</b>- Maintain transaction records and reconcile accounts</p>
                                <p><b>Payroll Specialists</b>- Handle salary processing and tax deductions</p>
                                <p><b>Auditors</b>- Conduct internal and external audits to ensure financial integrity</p>
                                <p><b>Tax Consultants</b>- Optimize tax planning and ensure regulatory compliance</p>

                            </div>
                            <div class="tabs-box mb_50">
                                <ul class="tab-btns tab-buttons">
                                    <li class="tab-btn active-btn" data-tab="#tab-1"><i class="icon-43"></i>Excessive tax burdens</li>
                                    <li class="tab-btn" data-tab="#tab-2"><i class="icon-43"></i>Compliance & accuracy risks</li>
                                    <li class="tab-btn" data-tab="#tab-3"><i class="icon-43"></i>Inefficient financial management</li>
                                </ul>
                                <div class="tabs-content">
                                    <div class="tab active-tab" id="tab-1">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="assets/images/Financial1.png" alt=""></figure>
                                            <div class="content-box">
                                                <h6>Excessive tax burdens</h6>
                                                <p>Optimizing tax planning strategies for cost efficiency</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab" id="tab-2">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="assets/images/Financial2.png" alt=""></figure>
                                            <div class="content-box">
                                                <h6>Compliance & accuracy risks</h6>
                                                <p>Reducing financial risks with expert auditing and reporting</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab" id="tab-3">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="assets/images/Financial3.png" alt=""></figure>
                                            <div class="content-box">
                                                <h6>Inefficient financial management</h6>
                                                <p>Providing top-tier finance professionals to streamline operations</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
